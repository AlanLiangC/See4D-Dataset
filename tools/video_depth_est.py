...
class Fast3R_Inferencer:
    ...
    def inference_sample(self, filelist): # TODO: Only for image.path list now. like: ["path/to/image1.jpg", "path/to/image2.jpg", "path/to/image3.jpg"]
...
if __name__ == "__main__":
    ...
    try:
        ...
        raise NotImplementedError('Init video depth est model failed')

    # test fast3r
    try:
        fast3r_egine = Fast3R_Inferencer(ckpt_path='pretrained_models/fast3r/model.safetensors')
    except:
        raise NotImplementedError('Init fast3R model failed')
